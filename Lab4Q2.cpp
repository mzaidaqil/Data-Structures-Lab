...
void deleteSubject(Subject *&head){

    string code;
    cout<<"\n\n:: Delete Subject Record::"<<endl;
        ...
        cout << "\nWhich subject you want to delete? Enter Code fo Subject : ";
        cin.ignore();
        getline(cin, code);

            if(head == NULL){
                cout << "No Subject to be deleted.";
                return;
            }

            //case where the node find at the first node, so delete in front. 
            ...
            if(head->scode == code){
                ...
                //traverse to find the code
                while(current != NULL && current->scode != code){
